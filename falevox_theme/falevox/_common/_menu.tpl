...
<div class="sidebar-menu">
    <header class="logo-env">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="{$WEBPATH}themes/{$THEMENAME}/images/falevox_logo_mini2.png" width="180" alt="" />
            </a>
        </div>
        <!-- logo collapse icon -->
...
<div style="height:83px;background-color:#0c0731;padding:15px;">
    ...
    <span style='float:right; width:400px;'>
        ...
        <li id="header_notification_bar" class="profile-info dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="https://wa.me/551832568300" target="_blank"><i class="fa fa-external-link"></i>Suporte</a></li>
                <li><a href="#" id="dialogaboutissabel"><i class="fa fa-info-circle"></i>Sobre o sistema</a></li>
            </ul>
        </li>
